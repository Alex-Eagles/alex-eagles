...
function AnimatedNavMenuButton() {
  ...
  // Close the menu, wait for animation, then navigate
        ...
        >
          ...
          {isOpen ? (
            ...
            <>
              ...
              <span className="button-text-nav">
                Close
              </span>
      ...
      <div className="menu-content-nav">
        ...
        <div className="footer-nav">
          ...
          <div
            ...
            style={{
              transitionDelay:
                `${(menuItems.length + footerLinks.length) * 75}ms`
            }}
