...
bst.insert("Team", "/TeamPage"); // Correct path for TeamPage
bst.insert("Sponsors", "/SponsersPage"); // Correct path for SponsorsPage
bst.insert("Publications", "/PublicationsPage"); // Correct path for PublicationsPage
